...
const SearchSelectChampionship = ({ onSelectItem }: SearchSelectProps) => {
  ...
  const handleSearch = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const playersCollection = collection(db, 'championships');
...
export default SearchSelectChampionship;